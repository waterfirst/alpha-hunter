...
W, H = 1920, 2800
OUT = "/home/ubuntu/.cokacdir/workspace/cp7jpheo/alpha_hunter/pension_dashboard.png"
...
draw.text((W-450, 15), "2026-04-03", font=font(24), fill=(100, 120, 160))
...
draw.text((40, y+50), "예상 적립금: 8,500만원", font=font(22), fill=(180, 200, 230))

dc_etfs = [
    ("TIGER 반도체TOP10", "396500", 25, 33210, +2.8, [30,31,32,31,33,32,33,34,33]),
    ("KODEX 200", "069500", 20, 81225, +0.9, [78,79,80,79,81,80,81,82,81]),
    ("TIGER 미국S&P500", "360750", 20, 16500, -0.4, [17,17,16.5,16.8,16.5,16.2,16.5,16.3,16.5]),
    ("KODEX 미국나스닥100", "379800", 15, 22300, +0.3, [21,22,21.5,22,21.8,22.2,22,22.3,22.3]),
    ("TIGER 단기통안채", "157450", 10, 104500, +0.01, [104,104.1,104.2,104.3,104.2,104.4,104.3,104.5,104.5]),
    ("현금성 (RP/MMF)", "-", 10, None, 0, []),
]
...
colors_dc = [(50,120,200), (40,160,120), (60,100,180), (100,80,180), (80,100,60), (60,60,80)]
...
draw.text((W//2+30, y+50), "예상 적립금: 4,200만원", font=font(22), fill=(200, 190, 230))

irp_etfs = [
    ("TIGER 미국S&P500", "360750", 30, 16500, -0.4, [17,17,16.5,16.8,16.5,16.2,16.5,16.3,16.5]),
    ("KODEX 미국나스닥100", "379800", 20, 22300, +0.3, [21,22,21.5,22,21.8,22.2,22,22.3,22.3]),
    ("TIGER 미국배당다우존스", "458730", 15, 11200, +1.2, [10.8,11,10.9,11.1,11,11.2,11.1,11.2,11.2]),
    ("KODEX TRF3070", "294400", 20, 11800, +0.2, [11.5,11.6,11.6,11.7,11.7,11.8,11.7,11.8,11.8]),
    ("TIGER 단기통안채", "157450", 15, 104500, +0.01, [104,104.1,104.2,104.3,104.2,104.4,104.3,104.5,104.5]),
]
...
colors_irp = [(100,60,200), (140,80,220), (80,120,200), (60,80,120), (50,60,80)]
...
assets = [
    ("퇴직연금 (DC)", "85,000,000원", (100, 180, 255)),
    ("개인연금 (IRP)", "42,000,000원", (180, 140, 255)),
    ("Alpha Hunter ETF", "100,000,000원 (가상)", (80, 200, 140)),
    ("Alpha Hunter 개별주", "$100,000 (가상)", (200, 180, 100)),
]
